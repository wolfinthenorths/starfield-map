...
map.getPane("cityHitPane").style.zIndex = 300;
...
function openPanel(item, kind) {
  ...
  if (kind === "vault") {
    ...
    content.innerHTML = `
      ...
      <div class="card-section"><h3>Районы</h3><p>После клика по городу районы становятся видимыми и кликабельными прямо на карте.</p></div>
    `;
  }
...
function showCity(city) {
  ...
  map.fitBounds(viewBounds.pad(0.16), {
    animate: true,
    maxZoom: 2
  });
